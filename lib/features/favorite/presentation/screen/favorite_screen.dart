...
import '../../../list_of_match/presentation/component/widgets/common/custom_appbar.dart';
          ...
          return BlocBuilder<MatchBloc, MatchState>(
            ...
            builder: (context, state) {
              final favoriteMatches =
                  state.upcomingMatch.where((match) {
                    final isFavorite = state.favoriteTeamIds.contains(
                      match,
                    );
                    return isFavorite;
                  }).toList();
              ...
              final color1 = isDark ? Color(0xFF0A1931) : Colors.orange.shade700;
              final color2 = isDark ? Color(0xFF185ADB) : Colors.amber.shade600;

              return ListView.builder(
                itemCount: favoriteMatches.length,
                itemBuilder: (context, index) {
                  final call = favoriteMatches[index];
                  // FIX: Replaced the incorrect Expanded(ListTile) with a robust Card layout.
                  return Card(
